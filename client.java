...
public class client implements ActionListener
{
    ...
    client()
    {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("C:\\Users\\Adithya\\Documents\\icons\\2.png"));
        ...
        JLabel name = new JLabel("Kashyap");
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            Socket s = new Socket("127.0.0.1", 6001); // connection this to server class 
